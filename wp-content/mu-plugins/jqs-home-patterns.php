...
function jqs_home_patterns_runtime_styles() {
	...
	$css = 'p { letter-spacing: -0.01em !important; } '
		...
		. '@media (max-width: 767px) { .entry-content .wp-block-group.has-border-color[style*="border-color:#3b58b7"][style*="border-width:4px"] { width: 100%; max-width: calc(100% - 20px); margin-left: auto; margin-right: auto; box-sizing: border-box; } } '
