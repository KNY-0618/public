...
function jqs_home_patterns_runtime_styles() {
	...
	$css = 'p { letter-spacing: -0.01em !important; } '
		...
		. '.jqs-office-list > h3.wp-block-heading { margin-bottom: 0 !important; } '
				...
				. '@media (max-width: 781px) { .jqs-office-list .wp-block-columns.are-vertically-aligned-center > .wp-block-column:nth-child(4) { padding-left: 0 !important; justify-content: center !important; } .jqs-office-list .wp-block-columns.are-vertically-aligned-center > .wp-block-column:nth-child(4) a { max-width: 420px !important; margin-left: auto !important; margin-right: auto !important; } } '
				. '@media (max-width: 781px) { .jqs-vehicle-types .jqs-vehicle-types__header { justify-content: center !important; text-align: center !important; } .jqs-vehicle-types .jqs-vehicle-title-icon { text-align: center !important; } .jqs-vehicle-types .jqs-vehicle-title-icon img { margin-left: auto !important; margin-right: auto !important; } .jqs-vehicle-types .jqs-vehicle-types__header > .wp-block-column:last-child { padding-left: 0 !important; } .jqs-vehicle-types .jqs-vehicle-types__header .wp-block-heading, .jqs-vehicle-types .jqs-vehicle-types__header p { text-align: center !important; } } '
