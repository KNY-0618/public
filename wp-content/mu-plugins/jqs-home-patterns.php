...
function jqs_home_patterns_runtime_styles() {
	...
	$css = 'p { letter-spacing: -0.01em !important; } '
		...
		. '.jqs-independent-startup > .wp-block-heading, .jqs-independent-startup > p, .jqs-independent-startup > .wp-block-table, .jqs-independent-startup > .wp-block-buttons, .jqs-independent-startup > .wp-block-image, .jqs-independent-startup > .wp-block-group, .jqs-independent-startup > .wp-block-columns { width: 100% !important; max-width: 100% !important; margin-left: auto !important; margin-right: auto !important; box-sizing: border-box !important; } '
		. '.jqs-independent-startup .jqs-independent-startup__section-title { margin: 0 0 0.8rem 0 !important; padding: 0.8rem 1rem !important; background-color: #3b58b7 !important; color: #ffffff !important; text-align: center !important; box-sizing: border-box !important; } '
		. '.jqs-contact-page-privacy .jqs-independent-startup__section-title { margin: 0 0 0.8rem 0 !important; padding: 0.8rem 1rem !important; background-color: #3b58b7 !important; color: #ffffff !important; text-align: center !important; box-sizing: border-box !important; } '
