...
';
	...
	$recruit_anchor_buttons_pattern_content = '
<!-- wp:group {"align":"full","className":"jqs-recruit-anchor-buttons","layout":{"type":"constrained","contentSize":"1100px"}} -->
...
<!-- wp:group {"align":"full","className":"jqs-company-profile","style":{"spacing":{"padding":{"top":"2rem","bottom":"2rem"}}},"layout":{"type":"constrained","contentSize":"1100px"}} -->
<div class="wp-block-group alignfull jqs-company-profile" style="padding-top:2rem;padding-bottom:2rem">
...
function jqs_home_patterns_runtime_styles() {
	...
	$css = 'p { letter-spacing: -0.01em !important; } '
		...
		. '@media (max-width: 767px) { .entry-content .wp-block-columns.is-not-stacked-on-mobile:has(img[src*="allow_right_pic.png"]), .site-main .wp-block-columns.is-not-stacked-on-mobile:has(img[src*="allow_right_pic.png"]) { display: grid !important; grid-template-columns: repeat(2, minmax(0, 1fr)) !important; gap: 0.9rem 0.9rem !important; justify-items: center !important; } .entry-content .wp-block-columns.is-not-stacked-on-mobile:has(img[src*="allow_right_pic.png"]) > .wp-block-column[style*="flex-basis:3%"], .site-main .wp-block-columns.is-not-stacked-on-mobile:has(img[src*="allow_right_pic.png"]) > .wp-block-column[style*="flex-basis:3%"] { display: none !important; } .entry-content .wp-block-columns.is-not-stacked-on-mobile:has(img[src*="allow_right_pic.png"]) > .wp-block-column:not([style*="flex-basis:3%"]), .site-main .wp-block-columns.is-not-stacked-on-mobile:has(img[src*="allow_right_pic.png"]) > .wp-block-column:not([style*="flex-basis:3%"]) { width: 100% !important; max-width: 100% !important; margin: 0 !important; } .entry-content .wp-block-columns.is-not-stacked-on-mobile:has(img[src*="allow_right_pic.png"]) > .wp-block-column:not([style*="flex-basis:3%"]) > p.has-text-align-center, .site-main .wp-block-columns.is-not-stacked-on-mobile:has(img[src*="allow_right_pic.png"]) > .wp-block-column:not([style*="flex-basis:3%"]) > p.has-text-align-center { font-size: 18px !important; } } '
		. '.jqs-vehicle-types .jqs-vehicle-types__header { display: flex !important; flex-wrap: nowrap !important; align-items: center !important; column-gap: 0.7rem !important; } '
		. '.jqs-vehicle-types .jqs-vehicle-types__header > .wp-block-column:first-child { flex: 0 0 120px !important; max-width: 120px !important; min-width: 120px !important; } '
		. '.jqs-vehicle-types .jqs-vehicle-types__header > .wp-block-column:last-child { flex: 1 1 auto !important; min-width: 0 !important; padding-left: 0.45rem !important; overflow: visible !important; } '
		. '.jqs-vehicle-types .jqs-vehicle-title-icon { margin: 0 !important; } '
		. '.jqs-vehicle-types .jqs-vehicle-title-icon img { width: 120px !important; max-width: 120px !important; display: block !important; transform: scaleX(-1); } '
		...
		. '.jqs-independent-startup { text-align: inherit !important; box-sizing: border-box !important; } '
		. '.jqs-independent-startup .jqs-independent-startup__banner { margin-top: 0 !important; margin-bottom: 0 !important; } '
		...
		. '.jqs-independent-startup .jqs-independent-startup__section-title { margin-bottom: 0.8rem !important; padding: 0.8rem 1rem !important; background-color: #3b58b7 !important; color: #ffffff !important; text-align: center !important; box-sizing: border-box !important; } '
		. '.jqs-contact-page-privacy .jqs-independent-startup__section-title { margin-bottom: 0.8rem !important; padding: 0.8rem 1rem !important; background-color: #3b58b7 !important; color: #ffffff !important; text-align: center !important; box-sizing: border-box !important; } '
		...
		. ':where(.entry-content, .site-main) .jqs-company-overview-banner__cover { width: 1100px !important; max-width: 100% !important; margin-left: auto !important; margin-right: auto !important; } '
		. '@media (max-width: 767px) { .jqs-company-overview-banner { padding-left: 0 !important; padding-right: 0 !important; } :where(.entry-content, .site-main) .jqs-company-overview-banner__cover { min-height: 130px !important; } } '
		...
		. '.jqs-newgrad-job-tabs { padding-top: 0 !important; padding-bottom: 0 !important; } '
		...
		. '.jqs-newgrad-tab2-table { padding-top: 0 !important; padding-bottom: 0 !important; } '
		...
		. '.jqs-newgrad-four-tables { padding-top: 0 !important; padding-bottom: 0 !important; margin-bottom: 0 !important; } '
		...
		. '.jqs-office-list > h3.wp-block-heading { margin-bottom: 0 !important; } '
				...
				. '@media (max-width: 1024px) { .jqs-office-list .wp-block-columns.are-vertically-aligned-center > .wp-block-column:nth-child(4) a { min-width: 0 !important; width: 100% !important; max-width: 100% !important; white-space: nowrap !important; font-size: clamp(14px, 1.5vw, 16px) !important; letter-spacing: 0 !important; } } '
				. '@media (max-width: 781px) { .jqs-office-list .wp-block-columns.are-vertically-aligned-center > .wp-block-column:nth-child(4) { padding-left: 0 !important; justify-content: center !important; } .jqs-office-list .wp-block-columns.are-vertically-aligned-center > .wp-block-column:nth-child(4) a { margin-left: auto !important; margin-right: auto !important; } } '
				. '@media (max-width: 781px) { .jqs-vehicle-types .jqs-vehicle-types__header { justify-content: center !important; text-align: center !important; gap: 0 !important; } .jqs-vehicle-types .jqs-vehicle-title-icon { text-align: center !important; margin: 0 !important; } .jqs-vehicle-types .jqs-vehicle-title-icon img { margin-left: auto !important; margin-right: auto !important; margin-bottom: 0 !important; } .jqs-vehicle-types .jqs-vehicle-types__header > .wp-block-column:last-child { padding-left: 0 !important; } .jqs-vehicle-types .jqs-vehicle-types__header .wp-block-heading { margin-top: 0 !important; } .jqs-vehicle-types .jqs-vehicle-types__header .wp-block-heading, .jqs-vehicle-types .jqs-vehicle-types__header p { text-align: center !important; } } '
				. '@media (max-width: 781px) { .wp-block-columns:has(img[src*="momotarou_top_img.png"]) { justify-content: center !important; text-align: center !important; } .wp-block-columns:has(img[src*="momotarou_top_img.png"]) > .wp-block-column { flex-basis: 100% !important; text-align: center !important; } .wp-block-columns:has(img[src*="momotarou_top_img.png"]) .wp-block-image { margin-left: auto !important; margin-right: auto !important; margin-bottom: 0 !important; text-align: center !important; } .wp-block-columns:has(img[src*="momotarou_top_img.png"]) .wp-block-image img { margin-left: auto !important; margin-right: auto !important; display: block !important; } .wp-block-columns:has(img[src*="momotarou_top_img.png"]) .wp-block-heading, .wp-block-columns:has(img[src*="momotarou_top_img.png"]) p { text-align: center !important; } } '
				. '@media (max-width: 781px) { .ct-footer [data-row*="top"] .wp-block-columns.are-vertically-aligned-center { justify-content: center !important; text-align: center !important; } .ct-footer [data-row*="top"] .wp-block-columns.are-vertically-aligned-center > .wp-block-column { text-align: center !important; } .ct-footer [data-row*="top"] .wp-block-columns.are-vertically-aligned-center .wp-block-image img { margin-left: auto !important; margin-right: auto !important; } .ct-footer [data-row*="top"] .wp-block-columns.are-vertically-aligned-center .wp-block-heading { text-align: center !important; } } '
