...
function jqs_enqueue_noto_sans_jp() {
	...
	wp_add_inline_style(
		'jqs-noto-sans-jp-global',
		'@media (min-width: 782px) { [data-header*="type-1"] { --header-height: 100px !important; --header-sticky-height: 100px !important; } [data-header*="type-1"] .ct-header [data-row*="middle"] { --height: 100px !important; min-height: 100px !important; height: 100px !important; } [data-header*="type-1"] .ct-header [data-row*="middle"] > div { min-height: 100px !important; height: 100px !important; } [data-header*="type-1"] .ct-header [data-row*="middle"] [data-column] { min-height: 100px !important; height: 100px !important; } [data-header*="type-1"] .ct-header [data-id="menu"] > ul > li > a { --theme-line-height: 1.2 !important; line-height: 1.2 !important; height: auto !important; padding-top: 0 !important; padding-bottom: 0 !important; display: inline-flex !important; align-items: center !important; } } @media (max-width: 781px) { [data-header*="type-1"] { --header-height: 50px !important; --header-sticky-height: 50px !important; } [data-header*="type-1"] .ct-header [data-row*="middle"] { --height: 50px !important; min-height: 50px !important; height: 50px !important; } [data-header*="type-1"] .ct-header [data-row*="middle"] > div { min-height: 50px !important; height: 50px !important; } [data-header*="type-1"] .ct-header [data-row*="middle"] [data-column] { min-height: 50px !important; height: 50px !important; } }'
	);
