...
function jqs_enqueue_noto_sans_jp() {
	...
	wp_add_inline_style(
		'jqs-noto-sans-jp-global',
		'@media (min-width: 1000px) { [data-footer*="type-1"] .ct-footer [data-row*="top"] > div { grid-template-columns: auto auto minmax(0, 1fr) !important; column-gap: 12px !important; align-items: center !important; } [data-footer*="type-1"] .ct-footer [data-row*="top"] [data-column="widget-area-1"] { justify-content: center !important; align-items: center !important; text-align: center !important; } [data-footer*="type-1"] .ct-footer [data-row*="top"] [data-column="widget-area-1"] img { width: min(105px, 100%) !important; height: auto !important; margin-inline: auto !important; } [data-footer*="type-1"] .ct-footer [data-row*="top"] [data-column*="widget-area"] { font-size: 12px !important; } [data-footer*="type-1"] .ct-footer [data-row*="top"] [data-column*="widget-area"] :is(p, li, a, span, div) { font-size: 12px !important; line-height: 1.6 !important; } }'
	);
